...
from tools.DataPre import LoadDataset, \
    DetectOutliers, DataScatter, FeatureSelect
from tools.AnalysisTools import validation_compare_plot
...
if __name__ == '__main__':
    ...
    gol.set_value("targets", targets)
    validation_compare_plot(feature_transformed, targets, df_blast_data)
